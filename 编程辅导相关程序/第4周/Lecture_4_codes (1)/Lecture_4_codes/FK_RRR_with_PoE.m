...
S1 = [omg_hat_1;v_hat_1]; % this is a 6x1 vertical vector of S1
%compute the screw axis in skew symmetric form
S1mat = VecTose3(S1); % this command transforms the S1 vector into a 4x4 skew symmetric matrix suitable for doing the matrix exponential
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% S2
omg_hat_2 = [0 -1 0]';
q2 = [L1 0 0]';
...
plot3([T_s2(1,4) T_se(1,4)],[T_s2(2,4) T_se(2,4)],[T_s2(3,4) T_se(3,4)], 'o-r','linewidth',1)
