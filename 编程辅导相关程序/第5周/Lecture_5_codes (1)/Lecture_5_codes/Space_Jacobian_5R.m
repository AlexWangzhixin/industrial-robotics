...
hold on
trplot(Ts)
trplot(Tse, 'color', 'k', 'length', 0.2)
trplot(M1e, 'color', 'k', 'length', 0.2)
trplot(M2e, 'color', 'k', 'length', 0.2)
trplot(M3e, 'color', 'k', 'length', 0.2)
trplot(M4e, 'color', 'k', 'length', 0.2)
trplot(M5e, 'color', 'k', 'length', 0.2)
...
Tes = TransInv(MatrixExp6(S1mat*theta1)*MatrixExp6(S2mat*theta2)*MatrixExp6(S3mat*theta3)...
    *MatrixExp6(S4mat*theta4)*MatrixExp6(S5mat*theta5)*M);
